...
public class PassengerActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRequestCar = findViewById(R.id.button);
    ...
    //    btnBeep = findViewById(R.id.btnBeepBeep);
        ...
        findViewById(R.id.LogoutFromPassengerActivity).setOnClickListener(new View.OnClickListener() {
            @Override
  ...
  Double lat=pLocation.getAltitude();
        Log.i("tag",lat+"");
        if (isCarReady == false) {
